...
function push_rs232(){
    var send_frame = [frame_header,rs_status,rs_line_length,rs_roller_dist,rs_record_stat,(rs_interia*1000).toString(),calib_force.toString(),damping_dynamic,damping_static,frame_terminator];
